-- MS SQL version of testSQL.sql ALL in one
-- create new test database including tables and keys and insert test data
-- REMOVED 'GO' because it caused compilation error.
