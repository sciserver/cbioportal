...
-- TODO DEFINE: FOREIGNKEY (`CANCER_STUDY_ID`) REFERENCES `cancer_study` (`CANCER_STUDY_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`PATIENT_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`INTERNAL_ID`) REFERENCES `gene_panel` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED - used ON DELETE NO ACTION instead of ON DELETE CASCADE
ALTER TABLE sample_profile ADD CONSTRAINT fk_sample_profile_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`SITE1_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`SITE2_ENTREZ_GENE_ID`) REFERENCES `gene` (`ENTREZ_GENE_ID`) ON DELETE CASCADE //JK-UPDATED : USED ON DELETE NO ACTION
ALTER TABLE structural_variant ADD CONSTRAINT fk_structural_variant_SITE2_ENTREZ_GENE_ID FOREIGN KEY(SITE2_ENTREZ_GENE_ID) REFERENCES [gene](ENTREZ_GENE_ID) ON DELETE NO ACTION


-- TODO DEFINE: FOREIGNKEY (`GENETIC_PROFILE_ID`) REFERENCES `genetic_profile` (`GENETIC_PROFILE_ID`) ON DELETE CASCADE //JK-UPDATED : USED ON DELETE NO ACTION
ALTER TABLE structural_variant ADD CONSTRAINT fk_structural_variant_GENETIC_PROFILE_ID FOREIGN KEY(GENETIC_PROFILE_ID) REFERENCES [genetic_profile](GENETIC_PROFILE_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED : used ON DELETE NO ACTION
ALTER TABLE mutation ADD CONSTRAINT fk_mutation_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED: used ON DELETE NO ACTION
ALTER TABLE mutation_count ADD CONSTRAINT fk_mutation_count_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION

ALTER TABLE [clinical_patient] ADD CONSTRAINT pk_clinical_patient PRIMARY KEY ([INTERNAL_ID],[ATTR_ID])


-- TODO DEFINE: FOREIGNKEY (`INTERNAL_ID`) REFERENCES `patient` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`INTERNAL_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED: used DELETE ON NO ACTION
ALTER TABLE protein_array_data ADD CONSTRAINT fk_protein_array_data_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED : used  ON DELETE NO ACTION
ALTER TABLE sample_cna_event ADD CONSTRAINT fk_sample_cna_event_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`SAMPLE_ID`) REFERENCES `sample` (`INTERNAL_ID`) ON DELETE CASCADE //JK-UPDATED: used ON DELETE NO ACTION
ALTER TABLE copy_number_seg ADD CONSTRAINT fk_copy_number_seg_SAMPLE_ID FOREIGN KEY(SAMPLE_ID) REFERENCES [sample](INTERNAL_ID) ON DELETE NO ACTION
...
-- TODO DEFINE: FOREIGNKEY (`CLINICAL_EVENT_ID`) REFERENCES `clinical_event` (`CLINICAL_EVENT_ID`) ON DELETE CASCADE //JK-UPDATED
