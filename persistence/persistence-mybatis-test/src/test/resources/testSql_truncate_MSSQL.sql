-- This script is not used in building test database.
-- Truncate table and insert test data.

Use cbioportal_test_persistence;

 TRUNCATE TABLE dbo.info

 TRUNCATE TABLE dbo.clinical_event_data

 TRUNCATE TABLE dbo.clinical_event

 TRUNCATE TABLE dbo.pdb_uniprot_residue_mapping

 TRUNCATE TABLE dbo.pdb_uniprot_alignment

 TRUNCATE TABLE dbo.cosmic_mutation

 TRUNCATE TABLE dbo.copy_number_seg_file

 TRUNCATE TABLE dbo.copy_number_seg

 TRUNCATE TABLE dbo.sample_cna_event

 TRUNCATE TABLE dbo.cna_event

 TRUNCATE TABLE dbo.drug_interaction

 TRUNCATE TABLE dbo.drug

 TRUNCATE TABLE dbo.pfam_graphics

 TRUNCATE TABLE dbo.text_cache

 TRUNCATE TABLE dbo.gistic_to_gene

 TRUNCATE TABLE dbo.gistic

 TRUNCATE TABLE dbo.sanger_cancer_census

 TRUNCATE TABLE dbo.protein_array_cancer_study

 TRUNCATE TABLE dbo.protein_array_data

 TRUNCATE TABLE dbo.protein_array_target

 TRUNCATE TABLE dbo.protein_array_info

 TRUNCATE TABLE dbo.mut_sig

 TRUNCATE TABLE dbo.interaction

 TRUNCATE TABLE dbo.clinical_attribute_meta

 TRUNCATE TABLE dbo.clinical_sample

 TRUNCATE TABLE dbo.clinical_patient

 TRUNCATE TABLE dbo.mutation_count

 TRUNCATE TABLE dbo.mutation

 TRUNCATE TABLE dbo.mutation_event

 TRUNCATE TABLE dbo.structural_variant

 TRUNCATE TABLE dbo.sample_profile

 TRUNCATE TABLE dbo.gene_panel_list

 TRUNCATE TABLE dbo.gene_panel

 TRUNCATE TABLE dbo.genetic_profile_samples

 TRUNCATE TABLE dbo.genetic_alteration

 TRUNCATE TABLE dbo.genetic_profile

 TRUNCATE TABLE dbo.uniprot_id_mapping

 TRUNCATE TABLE dbo.gene_alias

 TRUNCATE TABLE dbo.gene

 TRUNCATE TABLE dbo.sample_list_list

 TRUNCATE TABLE dbo.sample_list
 ...
 TRUNCATE TABLE dbo.cancer_study

 TRUNCATE TABLE dbo.type_of_cancer
