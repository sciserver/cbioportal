...
package org.cbioportal.security.filters;
...
public class ProvidersCompositeFilter {
    ...
    public ArrayList<Filter> createListOfFilter() {
        return new ArrayList<Filter>();
    }

    @Bean(name="compositeFilter")
    // Is this the best way to instantiate filters?
    @DependsOn(value = {"googleFilter"})
